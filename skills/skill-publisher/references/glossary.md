...
| **Phase column (POLISH / AUDIT / TIER / PACKAGE / PR)** | The publisher ledger's Phase values, one per workflow stage that produces clusters. Distinct from skill-tracer's `TRACE`/`REVIEW` — different skill, different phases. |
