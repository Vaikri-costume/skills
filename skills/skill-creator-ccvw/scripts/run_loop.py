...
from scripts.run_eval import preflight_check, run_eval
...
def run_loop(
    ...
    # Degenerate case: no iteration ran (e.g. --max-iterations 0) — return a defined
    # loop-launch-failure result rather than crashing on max() of an empty history.
    if not history:
        return {
